...
export const JS_STRINGS_NUMBERS_LESSONS: LessonMeta[] = [
  { num: '01', slug: '01-numbers-math', title: 'Числа: методи, Math та особливості float', methods: 'toFixed · Math.round · parseInt · NaN · isFinite', difficulty: 'easy', crystals: 0 },
  { num: '02', slug: '02-strings-basics', title: 'Рядки: доступ до символів, довжина, регістр', methods: 'length · at() · toUpperCase · toLowerCase', difficulty: 'easy', crystals: 0 },
  { num: '03', slug: '03-string-search', title: 'Пошук підрядків у тексті', methods: 'indexOf · includes · startsWith · endsWith', difficulty: 'easy', crystals: 0 },
  { num: '04', slug: '04-string-slice', title: 'Отримання частини рядка та заміна', methods: 'slice · substring · replace · replaceAll', difficulty: 'easy', crystals: 0 },
  { num: '05', slug: '05-template-literals', title: 'Шаблонні рядки та Tagged Templates', methods: '${} · multiline · tagged template literals', difficulty: 'medium', crystals: 0 },
  { num: '06', slug: '06-regex-basics', title: 'Регулярні вирази в рядках: match та test', methods: 'RegExp · test · match · matchAll · split', difficulty: 'medium', crystals: 0 },
  { num: '07', slug: '07-intl-formatting', title: 'Міжнародне форматування (Intl)', methods: 'Intl.NumberFormat · Intl.DateTimeFormat', difficulty: 'medium', crystals: 0 },
  { num: '08', slug: '08-text-processing-project', title: 'Практикум: текстовий процесор', methods: 'обробка та нормалізація тексту', difficulty: 'medium', crystals: 0 },
];

export const JS_OBJECTS_STRUCTS_LESSONS: LessonMeta[] = [
  { num: '01', slug: '01-objects-basics', title: 'Обʼєкти: літерали, властивості та for..in', methods: '{} · in operator · for..in · delete', difficulty: 'easy', crystals: 0 },
  { num: '02', slug: '02-references-copying', title: 'Посилання, неглибоке копіювання та structuredClone', methods: 'Object.assign · spread ... · structuredClone', difficulty: 'medium', crystals: 0 },
  { num: '03', slug: '03-object-methods-this', title: 'Методи обʼєкта та контекст this', methods: 'this · method shorthand · object context', difficulty: 'medium', crystals: 0 },
  { num: '04', slug: '04-constructor-new', title: 'Функції-конструктори та оператор new', methods: 'function Constructor · new · new.target', difficulty: 'medium', crystals: 0 },
  { num: '05', slug: '05-optional-chaining', title: 'Опціональний ланцюжок ?. та Nullish ??', methods: '?. · ?.[] · ?() · ??', difficulty: 'easy', crystals: 0 },
  { num: '06', slug: '06-symbols-descriptors', title: 'Символи (Symbol) та дескриптори властивостей', methods: 'Symbol() · defineProperty · enumerable', difficulty: 'hard', crystals: 0 },
  { num: '07', slug: '07-map-set', title: 'Колекції Map, Set, WeakMap, WeakSet', methods: 'Map · Set · has · get · set · delete', difficulty: 'medium', crystals: 0 },
  { num: '08', slug: '08-destructuring-json', title: 'Деструктуризація обʼєктів та JSON методи', methods: '{ a, b } · [ x, y ] · JSON.stringify/parse', difficulty: 'medium', crystals: 0 },
];

export const JS_FUNCTIONS_DEEP_LESSONS: LessonMeta[] = [
  { num: '01', slug: '01-recursion-stack', title: 'Рекурсія та стек викликів', methods: 'recursion · base case · execution context', difficulty: 'medium', crystals: 0 },
  { num: '02', slug: '02-rest-spread', title: 'Залишкові параметри (Rest) та Spread', methods: '...rest · ...spread · arguments', difficulty: 'easy', crystals: 0 },
  { num: '03', slug: '03-closure-lexical-env', title: 'Замикання (Closures) та Лексичне оточення', methods: 'Lexical Environment · scope chain · closure', difficulty: 'medium', crystals: 0 },
  { num: '04', slug: '04-old-var-global', title: 'Застарілий var та обʼєкт globalThis', methods: 'var hoisting · globalThis · window/global', difficulty: 'easy', crystals: 0 },
  { num: '05', slug: '05-nfe-new-function', title: 'Іменовані Function Expressions та new Function', methods: 'named function expression · new Function', difficulty: 'medium', crystals: 0 },
  { num: '06', slug: '06-scheduling', title: 'Планування викликів: setTimeout та setInterval', methods: 'setTimeout · setInterval · clearTimeout', difficulty: 'easy', crystals: 0 },
  { num: '07', slug: '07-decorators-call-apply', title: 'Декоратори та переадресація: call / apply', methods: 'func.call() · func.apply() · forwarding', difficulty: 'hard', crystals: 0 },
  { num: '08', slug: '08-function-binding', title: 'Привʼязка контексту: func.bind() та втрата this', methods: 'func.bind() · partial application · arrow this', difficulty: 'hard', crystals: 0 },
];

export const JS_CLASSES_OOP_LESSONS: LessonMeta[] = [
  { num: '01', slug: '01-prototypal-inheritance', title: 'Прототипне успадкування та __proto__', methods: '[[Prototype]] · __proto__ · Object.create', difficulty: 'medium', crystals: 0 },
  { num: '02', slug: '02-function-prototype', title: 'Властивість F.prototype та конструктори', methods: 'F.prototype · constructor property', difficulty: 'medium', crystals: 0 },
  { num: '03', slug: '03-native-prototypes', title: 'Нативні прототипи та додавання поліфілів', methods: 'Array.prototype · polyfill · monkey patching', difficulty: 'medium', crystals: 0 },
  { num: '04', slug: '04-class-syntax', title: 'Синтаксис class: методи, конструктор, геттери', methods: 'class · constructor · get/set · methods', difficulty: 'easy', crystals: 0 },
  { num: '05', slug: '05-class-inheritance', title: 'Успадкування класів: extends та super', methods: 'extends · super() · method overriding', difficulty: 'medium', crystals: 0 },
  { num: '06', slug: '06-static-private-fields', title: 'Статичні методи та приватні поля (#private)', methods: 'static · #privateField · #privateMethod', difficulty: 'medium', crystals: 0 },
  { num: '07', slug: '07-instanceof-type-checking', title: 'Перевірка типу: instanceof та Symbol.hasInstance', methods: 'instanceof · Symbol.hasInstance · type checking', difficulty: 'medium', crystals: 0 },
  { num: '08', slug: '08-mixins-patterns', title: 'Домішки (Mixins) та патерни ООП', methods: 'Object.assign mixin · EventMixin', difficulty: 'hard', crystals: 0 },
];

export const JS_DOM_EVENTS_LESSONS: LessonMeta[] = [
  { num: '01', slug: '01-browser-environment', title: 'Браузерне оточення: BOM, DOM та window', methods: 'window · navigator · location · screen', difficulty: 'easy', crystals: 0 },
  { num: '02', slug: '02-dom-tree-navigation', title: 'DOM-дерево: вузли, навігація та діти', methods: 'childNodes · parentElement · nextSibling', difficulty: 'easy', crystals: 0 },
  { num: '03', slug: '03-searching-elements', title: 'Пошук елементів: querySelector, closest, matches', methods: 'querySelector · querySelectorAll · closest', difficulty: 'easy', crystals: 0 },
  { num: '04', slug: '04-node-properties', title: 'Властивості вузлів: innerHTML, textContent', methods: 'innerHTML · textContent · dataset · attributes', difficulty: 'easy', crystals: 0 },
  { num: '05', slug: '05-modifying-document', title: 'Модифікація документа: createElement, append, remove', methods: 'createElement · append · prepend · remove', difficulty: 'medium', crystals: 0 },
  { num: '06', slug: '06-styles-classes', title: 'Стилі та класи: classList та getComputedStyle', methods: 'classList.add/toggle · getComputedStyle', difficulty: 'easy', crystals: 0 },
  { num: '07', slug: '07-event-handlers', title: 'Введення у події та addEventListener', methods: 'addEventListener · removeEventListener · event', difficulty: 'easy', crystals: 0 },
  { num: '08', slug: '08-bubbling-delegation', title: 'Спливання, занурення та делегування подій', methods: 'event.stopPropagation · event.preventDefault · delegation', difficulty: 'medium', crystals: 0 },
];
...
export const ROADMAP_BLOCKS: RoadmapBlock[] = [
  ...
  },
  {
    ...
    topics: [
      'Частина 1: Основи мови (змінні, типи, оператори, функції)',
    ...
    children: [
      {
        ...
        subtitle: 'Змінні, типи даних, оператори, if/else, цикли та функції — 8 уроків',
        status: 'active',
        level: 'Початківець',
        readmePath: 'blocks/02-javascript-basics/README.md',
