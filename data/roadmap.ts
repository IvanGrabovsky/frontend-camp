...
export const JS_BASICS_LESSONS: LessonMeta[] = [
  { num: '01', slug: '01-what-is-js',          title: 'Що таке JavaScript та запуск коду',            methods: 'console.log · <script> · alert · V8 · DevTools', difficulty: 'easy',   crystals: 80 },
  { num: '02', slug: '02-algorithms-intro',     title: 'Основи алгоритмів та логічне мислення',        methods: 'алгоритм · покроковий план · вхідні дані · псевдокод', difficulty: 'easy',   crystals: 80 },
  { num: '03', slug: '03-escape-special-chars', title: 'Спецсимволи, екранування та переноси рядків',   methods: '\\n · \\t · \\\\ · \\\' · \\" · Unicode · шаблонні рядки', difficulty: 'easy',   crystals: 80 },
  { num: '04', slug: '04-variables',            title: 'Змінні та типи даних',                         methods: 'let · const · typeof · template literals', difficulty: 'easy',   crystals: 80 },
  { num: '05', slug: '05-operators',            title: 'Оператори та вирази',                          methods: '=== · ?? · ?. · && · || · математика',                  difficulty: 'easy',   crystals: 80 },
  { num: '06', slug: '06-conditions',           title: 'Умовні оператори',                             methods: 'if/else · тернарний · switch',              difficulty: 'easy',   crystals: 80 },
  { num: '07', slug: '07-loops',                title: 'Цикли',                                        methods: 'for · while · for...of · for...in',          difficulty: 'medium', crystals: 80 },
  { num: '08', slug: '08-functions',            title: 'Функції',                                      methods: 'function · arrow => · closure · rest',       difficulty: 'medium', crystals: 80 },
  { num: '09', slug: '09-objects',              title: "Об'єкти",                                     methods: 'деструктуризація · spread · Object.entries',  difficulty: 'medium', crystals: 80 },
  { num: '10', slug: '10-dom',                  title: 'DOM та події',                                 methods: 'querySelector · classList · addEventListener', difficulty: 'medium', crystals: 80 },
  { num: '11', slug: '11-async',                title: 'Async/Await та Fetch',                         methods: 'async/await · fetch · Promise · try/catch',  difficulty: 'hard',   crystals: 80 },
];

export const JS_STRINGS_NUMBERS_LESSONS: LessonMeta[] = [
  { num: '01', slug: '01-numbers-math', title: 'Числа: методи, Math та особливості float', methods: 'toFixed · Math.round · parseInt · NaN · isFinite', difficulty: 'easy', crystals: 80 },
  { num: '02', slug: '02-strings-basics', title: 'Рядки: доступ до символів, довжина, регістр', methods: 'length · at() · toUpperCase · toLowerCase', difficulty: 'easy', crystals: 80 },
  { num: '03', slug: '03-string-search', title: 'Пошук підрядків у тексті', methods: 'indexOf · includes · startsWith · endsWith', difficulty: 'easy', crystals: 80 },
  { num: '04', slug: '04-string-slice', title: 'Отримання частини рядка та заміна', methods: 'slice · substring · replace · replaceAll', difficulty: 'easy', crystals: 80 },
  { num: '05', slug: '05-template-literals', title: 'Шаблонні рядки та Tagged Templates', methods: '${} · multiline · tagged template literals', difficulty: 'medium', crystals: 80 },
  { num: '06', slug: '06-regex-basics', title: 'Регулярні вирази в рядках: match та test', methods: 'RegExp · test · match · matchAll · split', difficulty: 'medium', crystals: 80 },
  { num: '07', slug: '07-intl-formatting', title: 'Міжнародне форматування (Intl)', methods: 'Intl.NumberFormat · Intl.DateTimeFormat', difficulty: 'medium', crystals: 80 },
  { num: '08', slug: '08-text-processing-project', title: 'Практикум: текстовий процесор', methods: 'обробка та нормалізація тексту', difficulty: 'medium', crystals: 80 },
];

export const JS_OBJECTS_STRUCTS_LESSONS: LessonMeta[] = [
  { num: '01', slug: '01-objects-basics', title: 'Обʼєкти: літерали, властивості та for..in', methods: '{} · in operator · for..in · delete', difficulty: 'easy', crystals: 80 },
  { num: '02', slug: '02-references-copying', title: 'Посилання, неглибоке копіювання та structuredClone', methods: 'Object.assign · spread ... · structuredClone', difficulty: 'medium', crystals: 80 },
  { num: '03', slug: '03-object-methods-this', title: 'Методи обʼєкта та контекст this', methods: 'this · method shorthand · object context', difficulty: 'medium', crystals: 80 },
  { num: '04', slug: '04-constructor-new', title: 'Функції-конструктори та оператор new', methods: 'function Constructor · new · new.target', difficulty: 'medium', crystals: 80 },
  { num: '05', slug: '05-optional-chaining', title: 'Опціональний ланцюжок ?. та Nullish ??', methods: '?. · ?.[] · ?() · ??', difficulty: 'easy', crystals: 80 },
  { num: '06', slug: '06-symbols-descriptors', title: 'Символи (Symbol) та дескриптори властивостей', methods: 'Symbol() · defineProperty · enumerable', difficulty: 'hard', crystals: 80 },
  { num: '07', slug: '07-map-set', title: 'Колекції Map, Set, WeakMap, WeakSet', methods: 'Map · Set · has · get · set · delete', difficulty: 'medium', crystals: 80 },
  { num: '08', slug: '08-destructuring-json', title: 'Деструктуризація обʼєктів та JSON методи', methods: '{ a, b } · [ x, y ] · JSON.stringify/parse', difficulty: 'medium', crystals: 80 },
];

export const JS_FUNCTIONS_DEEP_LESSONS: LessonMeta[] = [
  { num: '01', slug: '01-recursion-stack', title: 'Рекурсія та стек викликів', methods: 'recursion · base case · execution context', difficulty: 'medium', crystals: 80 },
  { num: '02', slug: '02-rest-spread', title: 'Залишкові параметри (Rest) та Spread', methods: '...rest · ...spread · arguments', difficulty: 'easy', crystals: 80 },
  { num: '03', slug: '03-closure-lexical-env', title: 'Замикання (Closures) та Лексичне оточення', methods: 'Lexical Environment · scope chain · closure', difficulty: 'medium', crystals: 80 },
  { num: '04', slug: '04-old-var-global', title: 'Застарілий var та обʼєкт globalThis', methods: 'var hoisting · globalThis · window/global', difficulty: 'easy', crystals: 80 },
  { num: '05', slug: '05-nfe-new-function', title: 'Іменовані Function Expressions та new Function', methods: 'named function expression · new Function', difficulty: 'medium', crystals: 80 },
  { num: '06', slug: '06-scheduling', title: 'Планування викликів: setTimeout та setInterval', methods: 'setTimeout · setInterval · clearTimeout', difficulty: 'easy', crystals: 80 },
  { num: '07', slug: '07-decorators-call-apply', title: 'Декоратори та переадресація: call / apply', methods: 'func.call() · func.apply() · forwarding', difficulty: 'hard', crystals: 80 },
  { num: '08', slug: '08-function-binding', title: 'Привʼязка контексту: func.bind() та втрата this', methods: 'func.bind() · partial application · arrow this', difficulty: 'hard', crystals: 80 },
];

export const JS_CLASSES_OOP_LESSONS: LessonMeta[] = [
  { num: '01', slug: '01-prototypal-inheritance', title: 'Прототипне успадкування та __proto__', methods: '[[Prototype]] · __proto__ · Object.create', difficulty: 'medium', crystals: 80 },
  { num: '02', slug: '02-function-prototype', title: 'Властивість F.prototype та конструктори', methods: 'F.prototype · constructor property', difficulty: 'medium', crystals: 80 },
  { num: '03', slug: '03-native-prototypes', title: 'Нативні прототипи та додавання поліфілів', methods: 'Array.prototype · polyfill · monkey patching', difficulty: 'medium', crystals: 80 },
  { num: '04', slug: '04-class-syntax', title: 'Синтаксис class: методи, конструктор, геттери', methods: 'class · constructor · get/set · methods', difficulty: 'easy', crystals: 80 },
  { num: '05', slug: '05-class-inheritance', title: 'Успадкування класів: extends та super', methods: 'extends · super() · method overriding', difficulty: 'medium', crystals: 80 },
  { num: '06', slug: '06-static-private-fields', title: 'Статичні методи та приватні поля (#private)', methods: 'static · #privateField · #privateMethod', difficulty: 'medium', crystals: 80 },
  { num: '07', slug: '07-instanceof-type-checking', title: 'Перевірка типу: instanceof та Symbol.hasInstance', methods: 'instanceof · Symbol.hasInstance · type checking', difficulty: 'medium', crystals: 80 },
  { num: '08', slug: '08-mixins-patterns', title: 'Домішки (Mixins) та патерни ООП', methods: 'Object.assign mixin · EventMixin', difficulty: 'hard', crystals: 80 },
];

export const JS_DOM_EVENTS_LESSONS: LessonMeta[] = [
  { num: '01', slug: '01-browser-environment', title: 'Браузерне оточення: BOM, DOM та window', methods: 'window · navigator · location · screen', difficulty: 'easy', crystals: 80 },
  { num: '02', slug: '02-dom-tree-navigation', title: 'DOM-дерево: вузли, навігація та діти', methods: 'childNodes · parentElement · nextSibling', difficulty: 'easy', crystals: 80 },
  { num: '03', slug: '03-searching-elements', title: 'Пошук елементів: querySelector, closest, matches', methods: 'querySelector · querySelectorAll · closest', difficulty: 'easy', crystals: 80 },
  { num: '04', slug: '04-node-properties', title: 'Властивості вузлів: innerHTML, textContent', methods: 'innerHTML · textContent · dataset · attributes', difficulty: 'easy', crystals: 80 },
  { num: '05', slug: '05-modifying-document', title: 'Модифікація документа: createElement, append, remove', methods: 'createElement · append · prepend · remove', difficulty: 'medium', crystals: 80 },
  { num: '06', slug: '06-styles-classes', title: 'Стилі та класи: classList та getComputedStyle', methods: 'classList.add/toggle · getComputedStyle', difficulty: 'easy', crystals: 80 },
  { num: '07', slug: '07-event-handlers', title: 'Введення у події та addEventListener', methods: 'addEventListener · removeEventListener · event', difficulty: 'easy', crystals: 80 },
  { num: '08', slug: '08-bubbling-delegation', title: 'Спливання, занурення та делегування подій', methods: 'event.stopPropagation · event.preventDefault · delegation', difficulty: 'medium', crystals: 80 },
];
...
export const JS_ASYNC_LESSONS: LessonMeta[] = [
  { num: '01', slug: '01-event-loop', title: 'Як працює Event Loop та Call Stack', methods: 'Call Stack · Web APIs · Task Queue', difficulty: 'easy', crystals: 80 },
  { num: '02', slug: '02-micro-macro-tasks', title: 'Microtasks vs Macrotasks', methods: 'Promise.resolve · queueMicrotask · setTimeout', difficulty: 'medium', crystals: 80 },
  { num: '03', slug: '03-promises-deep', title: 'Promises: життєвий цикл та ланцюжки', methods: 'new Promise · then · catch · finally', difficulty: 'medium', crystals: 80 },
  { num: '04', slug: '04-promise-combinators', title: 'Комбінатори промісів', methods: 'all · allSettled · race · any', difficulty: 'medium', crystals: 80 },
  { num: '05', slug: '05-async-await-internals', title: 'Async/Await та генератори під капотом', methods: 'async/await · yield · generator function', difficulty: 'medium', crystals: 80 },
  { num: '06', slug: '06-abort-controller', title: 'Скасування запитів через AbortController', methods: 'AbortController · signal · timeout', difficulty: 'hard', crystals: 80 },
  { num: '07', slug: '07-web-workers', title: 'Багатопоточність у браузері: Web Workers', methods: 'new Worker · postMessage · onmessage', difficulty: 'hard', crystals: 80 },
  { num: '08', slug: '08-concurrency-patterns', title: 'Паттерни конкурентності та Debounce/Throttle', methods: 'p-limit · debounce · throttle', difficulty: 'hard', crystals: 80 },
];
...
export const ROADMAP_BLOCKS: RoadmapBlock[] = [
  ...
  },
  {
    ...
    status: 'active',
    level: 'Початківець → просунутий',
    readmePath: 'blocks/02-javascript-basics/README.md',
    courseSlug: 'javascript',
    startHref: '/courses/js-basics/01-what-is-js/',
    topics: [
      'Частина 1: Основи мови (вступ, алгоритми, спецсимволи, змінні, типи, оператори, функції)',
      'Частина 2: Рядки, числа та робота з текстом',
      'Частина 3: Масиви (21 урок з інтерактивними пісочницями)',
      'Частина 4: Обʼєкти, this, деструктуризація, Map/Set, JSON',
      'Частина 5: Просунута робота з функціями, замикання (Closures), call/apply/bind',
      'Частина 6: Прототипне успадкування, класи (ООП) та приватні поля',
      'Частина 7: Асинхронний JS, Promises, async/await та Event Loop',
      'Частина 8: Браузер: DOM дерево, навігація, події та маніпуляції',
    ],
    children: [
      {
        slug: 'js-basics',
        ...
        startHref: '/courses/js-basics/01-what-is-js/',
        topics: [
          'Що таке JavaScript & V8 рушій',
          'Основи алгоритмів & псевдокод',
          'Спецсимволи \\n, \\t, екранування',
          'Змінні let/const & типи даних',
          'Оператори ===, ??, ?.',
          'Умови if/else & switch',
      ...
      },
      {
        ...
        status: 'active',
        level: 'Початківець',
        readmePath: 'blocks/02-js-strings/README.md',
        courseSlug: 'js-strings',
        lessons: JS_STRINGS_NUMBERS_LESSONS,
        startHref: '/courses/js-strings/01-numbers-math/',
        topics: ['Числа & Math', 'Доступ до символів рядка', 'Пошук підрядків includes/indexOf', 'Вирізка тексту slice/substring', 'Шаблонні рядки ${}', 'Регулярні вирази RegExp', 'Міжнародне форматування Intl'],
      },
      {
        slug: 'js-arrays',
        order: 5.3,
      ...
      },
      {
        ...
        status: 'active',
        level: 'Середній',
        readmePath: 'blocks/02-js-objects/README.md',
        courseSlug: 'js-objects',
        lessons: JS_OBJECTS_STRUCTS_LESSONS,
        startHref: '/courses/js-objects/01-objects-basics/',
        topics: ['Літерали & for..in', 'Копіювання & structuredClone', 'Методи & контекст this', 'Конструктори new', 'Опціональний ланцюжок ?.', 'Symbol & дескриптори', 'Map / Set / WeakMap', 'Деструктуризація & JSON'],
      },
      {
        ...
        status: 'active',
        level: 'Середній → просунутий',
        readmePath: 'blocks/02-js-functions/README.md',
        courseSlug: 'js-functions',
        lessons: JS_FUNCTIONS_DEEP_LESSONS,
        startHref: '/courses/js-functions/01-recursion-stack/',
        topics: ['Рекурсія & стек', 'Rest & Spread', 'Замикання Closures', 'Старий var & globalThis', 'NFE & new Function', 'setTimeout & setInterval', 'Декоратори call/apply', 'Привʼязка bind()'],
      },
      {
        slug: 'js-classes-oop',
        order: 5.6,
        ...
        status: 'active',
        level: 'Середній → просунутий',
        readmePath: 'blocks/02-js-classes/README.md',
        courseSlug: 'js-classes',
        lessons: JS_CLASSES_OOP_LESSONS,
        startHref: '/courses/js-classes/01-prototypal-inheritance/',
        topics: ['Прототипи __proto__', 'F.prototype', 'Нативні прототипи', 'Синтаксис class & constructor', 'Успадкування extends & super', 'Статичні та приватні поля #', 'Перевірка instanceof', 'Mixins'],
      },
      {
        slug: 'js-async',
        order: 5.7,
        ...
        startHref: '/courses/js-async/01-event-loop/',
        topics: ['Event Loop & Call Stack', 'Microtasks vs Macrotasks', 'Promises під капотом', 'Promise combinators', 'Async/Await internals', 'AbortController', 'Web Workers', 'Concurrency patterns'],
      },
      {
        slug: 'js-dom-events',
        order: 5.8,
        ...
        status: 'active',
        level: 'Початківець → середній',
        readmePath: 'blocks/02-js-dom/README.md',
        courseSlug: 'js-dom',
        lessons: JS_DOM_EVENTS_LESSONS,
        startHref: '/courses/js-dom/01-browser-environment/',
        topics: ['BOM & DOM оточення', 'DOM-дерево & навігація', 'Пошук querySelector/closest', 'Властивості innerHTML/textContent', 'Модифікація createElement/append', 'Стилі & classList', 'Обробники addEventListener', 'Спливання & Делегування'],
      },
    ]
  },
  {
