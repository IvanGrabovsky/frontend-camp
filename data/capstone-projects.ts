...
export const CAPSTONE_PROJECTS: CapstoneProject[] = [
  ...
  },
  {
    ...
    description: 'Платформа для проходження курсів з інтерактивними завданнями, живим виконанням коду та інтерактивними бліц-тестами.',
    features: [
      'MDX-рендеринг уроків із вбудованими інтерактивними пісочницями коду',
      'Відстеження прогресу (Completion Rate, досягнення та бейджі)',
    ...
    portfolioHighlight: 'Демонструє вміння проектувати архітектуру для сучасних контентних та EdTech платформ.',
    difficulty: 'Junior+'
  },
  {
    id: 'apex-analytics',
